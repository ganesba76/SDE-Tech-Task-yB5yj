...
--Note :- Used Sqlite to load the data from JSONPlaceholder API.Database file attached.
...
--Note :-- Used MSSQL database for loading & building the Select statement as SQLlite is not friendly for data analysis
